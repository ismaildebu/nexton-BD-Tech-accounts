...
@if(session('warning'))
    <div x-data="{ show: true }"
        ...
        <div class="flex-1">
            <p class="text-sm font-medium text-amber-700 dark:text-amber-400">{{ session('warning') }}</p>
        </div>
...
@if(session('info'))
    <div x-data="{ show: true }"
        ...
        <div class="flex-1">
            <p class="text-sm font-medium text-blue-700 dark:text-blue-400">{{ session('info') }}</p>
        </div>
        <button @click="show = false" class="text-blue-400 hover:text-blue-600 transition-colors shrink-0">
            <i class="bi bi-x-lg text-sm"></i>
        </button>
    </div>
@endif