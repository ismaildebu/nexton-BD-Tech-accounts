                            ...
                            {{ $currentRole ? ucfirst($currentRole) : 'No Role' }}
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-right text-sm">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <a href="{{ route('system.users.roles', $user) }}"
   class="inline-flex items-center gap-1 rounded-lg border border-blue-200
          bg-white px-3 py-1.5 text-xs font-semibold text-blue-600 shadow-sm
          transition hover:bg-blue-50
          dark:border-blue-800 dark:bg-teal-800 dark:text-blue-400 dark:hover:bg-teal-700">
    Roles
</a>
