    ...
    $this->actingAs($this->admin)->post(route('media.returns.store'), [
        ...
        'items' => [
            ...
            [
                ...
                'paid_return_quantity' => 0,
                'free_return_quantity' => 25,
            ],
        ],
    ])->assertRedirect();
...
it('rejects return that exceeds distribution net_quantity via HTTP', function () {
    ...
    $dist = app(DistributionService::class)->create(
        $pub,
        '2026-09-01',
...
it('cannot return against another company distribution (company isolation)', function () {
    ...
    $distOther = app(DistributionService::class)->create(
        $pubOther,
        '2026-09-01',
        $otherCompany->id,
        $otherUser->id,
    ...
    $this->actingAs($this->admin)->post(route('media.returns.store'), [
        ...
        'media_distribution_id' => $distOther->id,
        'return_date' => '2026-09-02',
        'items' => [
            [
                'media_party_id' => $partyOther->id,
                'paid_return_quantity' => 10,
                'free_return_quantity' => 0,
            ],
        ],
    ...
    expect(
        MediaReturn::withoutGlobalScopes()
